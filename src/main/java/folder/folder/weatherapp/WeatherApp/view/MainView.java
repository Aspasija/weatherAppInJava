...
public class MainView<cityName> extends UI {
    ...
    private void setHeader(){
        ...
        Label Title = new Label("Weather APP in Java.");
    ...
    private void setLogo() {
        ...
        logo.setSource(new ExternalResource("https://img.freepik.com/premium-vector/weather-sunny-cloudy-day-rain-hail-snow-wind-line-round-modern-icons-set-vector-illustration_116137-1775.jpg?w=740"));
        logo.setWidth("500px");
    ...
    private void dashboardTitle() {
        ...
        //City Location
        location = new Label("Currently in Ljubljana");
    ...
    private void footer(){
        ...
        description.setValue("Weather App by Aspasija C. Visit my official website: aspasija.com ");
